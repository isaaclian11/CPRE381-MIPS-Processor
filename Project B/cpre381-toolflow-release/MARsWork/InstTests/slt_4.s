...
main:
    # Start Test
    addi $1, $0, -3  	# Load the value -3 into register 1  
    addi $2, $0, 1   	# Load the value 1 into register 2
    
	slt  $3, $1, $2		# Set register $3 if $1 < $2. In this case, $3 is set to 1.
	...
	# COMMENTS:
	# This test case covers when the first operand is less than the second operand and is a negative number. It is important to test this edge case, as this instruction is 
