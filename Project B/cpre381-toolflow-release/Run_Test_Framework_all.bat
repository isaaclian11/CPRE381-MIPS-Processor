...
echo MARsWork/allCommands.asm
%python_path% test_framework.py --asm-file MARsWork/allCommands.asm

for %%f in (MARsWork\InstTests\*) do ( echo  Now doing %%f
%python_path% test_framework.py --nocompile --asm-file %%f
)
